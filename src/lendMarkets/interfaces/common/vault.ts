...
export interface IVault {
    ...
    depositApprove: (assets: TAmount) => Promise<string[]>
    deposit: (assets: TAmount) => Promise<string>,
    ...
    mintApprove: (assets: TAmount) => Promise<string[]>
    mint: (vaultShares: TAmount) => Promise<string>,
    ...
    estimateGas: {
        depositApprove: (assets: TAmount) => Promise<TGas>,
        deposit: (assets: TAmount) => Promise<TGas>,
        mintApprove: (assets: TAmount) => Promise<TGas>,

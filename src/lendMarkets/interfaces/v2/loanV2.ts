...
export interface ILoanV2 {
    ...
    repayBands: (debt: TAmount, address?: string, shrink?: boolean) => Promise<[number, number]>;
    repayPrices: (debt: TAmount, address?: string, shrink?: boolean) => Promise<string[]>;
    ...
    repay: (debt: TAmount, address?: string, shrink?: boolean) => Promise<string>;
    ...
    estimateGas: {
        ...
        repay: (debt: TAmount, address?: string, shrink?: boolean) => Promise<TGas>;

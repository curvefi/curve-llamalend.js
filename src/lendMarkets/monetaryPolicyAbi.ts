...
const LEGACY_SIGNATURE_MONETARY_POLICIES: ReadonlySet<string> = new Set([
    '0x745422bf49f3f6e4a8e12e4abd19339e7910f8c9',
]);

export const resolveLendMonetaryPolicyAbi = (version: 'v1' | 'v2', monetaryPolicyAddress: string): any => {
    if (version === 'v1') return MonetaryPolicyABI;
    return LEGACY_SIGNATURE_MONETARY_POLICIES.has(monetaryPolicyAddress.toLowerCase())
        ? MonetaryPolicyABI
        : MonetaryPolicyV2ABI;
};
